...
export const WEAPONS = {
  ...
  sword: {
    n: 'Sword', dmg: 28, spd: 1.0, range: 55, arc: 90,
  ...
  knife: {
    n: 'Knife', dmg: 15, spd: 2.0, range: 35, arc: 70,
  ...
  bow: {
    n: 'Bow', dmg: 22, spd: 0.9, range: 350, arc: 0, ranged: true,
  ...
  spike_shield: {
    n: 'Spike Shield', dmg: 18, spd: 0.7, range: 45, arc: 60, defense: 0.3,
  ...
  spear: {
    n: 'Spear', dmg: 26, spd: 0.85, range: 95, arc: 45,
  ...
  katana: {
    n: 'Katana', dmg: 32, spd: 1.25, range: 60, arc: 100, crit: 0.2,
  ...
  knuckles: {
    n: 'Knuckles', dmg: 14, spd: 2.4, range: 30, arc: 80,
  ...
  dual_swords: {
    n: 'Dual Swords', dmg: 20, spd: 1.7, range: 55, arc: 100, multi: 2,
  ...
  axe: {
    n: 'Axe', dmg: 42, spd: 0.7, range: 60, arc: 110,
  ...
  morning_star: {
    n: 'Morning Star', dmg: 38, spd: 0.75, range: 65, arc: 120, stun: 0.15,
  ...
  scythe: {
    n: 'Scythe', dmg: 36, spd: 0.85, range: 78, arc: 140, lifesteal: 0.1,
  ...
  chain: {
    n: 'Chain', dmg: 24, spd: 1.1, range: 115, arc: 30,
  ...
  crossbow: {
    n: 'Crossbow', dmg: 34, spd: 0.7, range: 320, arc: 0, ranged: true, pierce: true,
  ...
  staff: {
    n: 'Staff', dmg: 18, spd: 1.1, range: 60, arc: 80, manaBoost: 0.25,
  ...
  whip: {
    n: 'Whip', dmg: 22, spd: 1.3, range: 98, arc: 30,
  ...
  war_hammer: {
    n: 'War Hammer', dmg: 50, spd: 0.55, range: 55, arc: 100, stun: 0.25,
  ...
  // ----- NEW RANGED -----
  throwing_knives: {
    n: 'Throwing Knives', dmg: 12, spd: 1.8, range: 260, arc: 0, ranged: true, multi: 2,
  ...
  slingshot: {
    n: 'Slingshot', dmg: 16, spd: 1.4, range: 300, arc: 0, ranged: true,
  ...
  boomerang: {
    n: 'Boomerang', dmg: 20, spd: 1.0, range: 280, arc: 0, ranged: true,
  ...
  shuriken: {
    n: 'Shuriken', dmg: 10, spd: 2.2, range: 240, arc: 0, ranged: true, multi: 4,
  ...
  chakram: {
    n: 'Chakram', dmg: 26, spd: 1.1, range: 300, arc: 0, ranged: true, pierce: true,
  ...
  blow_dart: {
    n: 'Blow Dart', dmg: 8, spd: 1.6, range: 320, arc: 0, ranged: true,
  ...
  catapult: {
    n: 'Catapult', dmg: 55, spd: 0.45, range: 300, arc: 0, ranged: true,
  ...
  ballista: {
    n: 'Ballista', dmg: 80, spd: 0.4, range: 420, arc: 0, ranged: true, pierce: true,
  ...
  hand_cannon: {
    n: 'Hand Cannon', dmg: 14, spd: 0.8, range: 160, arc: 0, ranged: true, multi: 6,
  ...
  magic_bow: {
    n: 'Spirit Bow', dmg: 30, spd: 1.0, range: 380, arc: 0, ranged: true,
  ...
  trident: {
    n: 'Trident', dmg: 34, spd: 0.9, range: 90, arc: 50, ranged: false,
  ...
  magic_sword: {
    n: 'Magic Sword', dmg: 24, spd: 1.0, range: 70, arc: 90, ranged: false,
  ...
  flame_blade: {
    n: 'Flame Blade', dmg: 30, spd: 1.1, range: 60, arc: 95,
  ...
  frost_fang: {
    n: 'Frost Fang', dmg: 28, spd: 1.15, range: 58, arc: 90,
  ...
  thunder_spear: {
    n: 'Thunder Spear', dmg: 36, spd: 0.9, range: 95, arc: 45,
  ...
  vampire_scythe: {
    n: 'Vampire Scythe', dmg: 40, spd: 0.8, range: 80, arc: 150, lifesteal: 0.35,
  ...
  gravity_maul: {
    n: 'Gravity Maul', dmg: 46, spd: 0.6, range: 70, arc: 120,
  ...
  void_edge: {
    n: 'Void Edge', dmg: 44, spd: 1.0, range: 62, arc: 95,
  ...
  storm_fan: {
    n: 'Storm Fan', dmg: 22, spd: 1.5, range: 70, arc: 360,
